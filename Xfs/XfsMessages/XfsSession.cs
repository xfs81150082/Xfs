...
{
	[XfsObjectSystem]
	public class SessionAwakeSystem : XfsAwakeSystem<Session, XfsAChannel>
	{
		public override void Awake(Session self, XfsAChannel b)
		{
			self.Awake(b);
		}
	}

	public sealed class Session : XfsEntity
	{
