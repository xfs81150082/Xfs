...
namespace Xfs
{
	public class OuterMessageDispatcher: IXfsMessageDispatcher
	{
        ...
        //            {
        //                // 非Actor消息
        //                //XfsGame.XfsSence.GetComponent<XfsMessageDispatcherComponent>().Handle(session, new XfsMessageInfo(opcode, message));
        //                break;
        //            }
        //    }
        //}
