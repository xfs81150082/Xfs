...
namespace Xfs
{
	...
	public class XfsStartConfigComponent : XfsComponent
	{
		...
		public void Awake()
		{
			...
			this.GateConfig = new XfsStartConfig() { SenceType = XfsSenceType.Gate, ServerIP = "127.0.0.1", Port = 2001 };
			this.DbConfig = new XfsStartConfig() { SenceType = XfsSenceType.Db, ServerIP = "127.0.0.1", Port = 1001 };
			this.configDict.Add((int)this.GateConfig.SenceType,this.GateConfig);
			this.configDict.Add((int)this.DbConfig.SenceType, this.DbConfig);
