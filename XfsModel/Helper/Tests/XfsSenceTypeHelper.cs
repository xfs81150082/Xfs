...
namespace Xfs
{
	...
	{
		public static List<XfsSceneType> GetServerTypes()
		{
			List<XfsSceneType> appTypes = new List<XfsSceneType> { XfsSceneType.Manager, XfsSceneType.Realm, XfsSceneType.Gate };
			return appTypes;
		}

		public static bool Is(this XfsSceneType a, XfsSceneType b)
		{
			if ((a & b) != 0)
			{
				return true;
