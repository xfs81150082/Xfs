...
namespace XfsDbServer
{
    public class XfsServerInit
    {
        ...
        public void Init()
        {
            ...
            XfsGame.XfsSence.AddComponent(new XfsTcpServerDbNet("127.0.0.1", 8115, 10));                                    ///服务器加载组件 : 通信组件Server
            ...
            XfsGame.XfsSystemMananger.AddComponent(new XfsTcpServerDbNetSystem());      ///服务器加载组件 : 套接字 外网 传输数据组件
